...
echo "● Instalar e configurar o proxy squid nas portas 8081, 3128, 8080 e 8799" ; echo "  para permitir conexões SSH para este servidor"
...
if [ -f "/usr/sbin/ufw" ] ; then
	ufw allow 443/tcp ; ufw allow 8081/tcp ; ufw allow 3128/tcp ; ufw allow 8799/tcp ; ufw allow 8082/tcp
fi
if [ -d "/etc/squid3/" ]
then
...
echo ""
tput setaf 7 ; tput setab 4 ; tput bold ; echo "Proxy Squid Instalado e rodando nas portas: 8081, 3128, 8080 e 8799" ; tput sgr0
